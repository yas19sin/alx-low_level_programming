 ...
 *         Otherwise, a pointer to the first node in the list where the value
 *         is located.
 *
 * Description: Prints a value every time it is compared in the list. The
 *              search uses the square root of the list size as the jump step.
 */
